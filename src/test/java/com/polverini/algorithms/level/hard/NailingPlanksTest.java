...
class NailingPlanksTest {
    ...
    void test() {
        INPUTS.forEach(holder -> {
            final var result = NailingPlanks.solution(holder.planksA, holder.planksB, holder.nails);
            assertEquals(holder.result, result);
        });
    }

    private record TestHolder(int[] planksA, int[] planksB, int[] nails, int result) {
    }
